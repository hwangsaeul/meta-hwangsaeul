...
SRC_URI = "https://gstreamer.freedesktop.org/src/gst-plugins-bad/gst-plugins-bad-${PV}.tar.xz \
           ...
           file://0001-srt-Add-authentication-to-srtsink-and-srtsrc-element.patch \
           file://0001-srtobject-post-a-message-on-the-bus-when-broken-sock.patch \
           file://0001-srtobject-obey-wait-for-connection-in-caller-mode.patch \
           file://0001-srtsink-remove-unused-connection_mode-variable.patch \
           file://0001-srtsrc-fix-typos.patch \
           file://0001-srtobject-make-possible-to-specify-more-sockopts-in-.patch \
           file://0001-srtobject-detect-socket-errors-from-srt_epoll_wait.patch \
           file://0001-srtobject-distinguish-authentication-error-messages.patch \
           file://0001-srt-Define-options-added-in-later-revisions.patch \
"
...
PACKAGECONFIG ??= " \
    ...
    ttml uvch264 webp \
    msdk opencv openjpeg \
    opusparse sctp tinyalsa \
    srt uvch264 v4l2codecs va x265 \
"
